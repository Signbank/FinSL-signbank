    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_required', models.ManyToManyField(help_text='This page will only be visible to members of these groups, leave blank to allow anyone to access.', to='auth.Group', null=True, blank=True)),
