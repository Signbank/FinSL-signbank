    ...
    def forwards(self, orm):
        ...
        db.create_table('video_video', (
            ('id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('geometry', self.gf('django.db.models.fields.CharField')
             (default='320x240', max_length='20')),
            ('original', self.gf('django.db.models.fields.files.FileField')
             (max_length=100)),
            ('h264', self.gf('django.db.models.fields.files.FileField')
             (max_length=100)),
            ('ogg', self.gf('django.db.models.fields.files.FileField')
             (max_length=100)),
        ))
        ...
        db.create_table('video_videofile', (
            ...
            ('videoset', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['video.VideoSet'])),
        ))
