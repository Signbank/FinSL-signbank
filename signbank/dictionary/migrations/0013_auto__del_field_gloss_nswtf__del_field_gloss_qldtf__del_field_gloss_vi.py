...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Gloss.qldtf'
        db.delete_column('dictionary_gloss', 'qldtf')

        # Deleting field 'Gloss.victf'
        db.delete_column('dictionary_gloss', 'victf')

        # Deleting field 'Gloss.auslextf'
        db.delete_column('dictionary_gloss', 'auslextf')

        # Deleting field 'Gloss.satf'
        db.delete_column('dictionary_gloss', 'satf')

        # Deleting field 'Gloss.nthtf'
        db.delete_column('dictionary_gloss', 'nthtf')

        # Deleting field 'Gloss.sthtf'
        db.delete_column('dictionary_gloss', 'sthtf')

        # Deleting field 'Gloss.watf'
        db.delete_column('dictionary_gloss', 'watf')
