...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'dictionary_gloss', 'relatArtic')

        # Deleting field 'Gloss.relOriMov'
        db.delete_column(u'dictionary_gloss', 'relOriMov')

        # Deleting field 'Gloss.relOriLoc'
        db.delete_column(u'dictionary_gloss', 'relOriLoc')

        # Deleting field 'Gloss.handCh'
        db.delete_column(u'dictionary_gloss', 'handCh')

        # Deleting field 'Gloss.movSh'
        db.delete_column(u'dictionary_gloss', 'movSh')

        # Deleting field 'Gloss.movDir'
        db.delete_column(u'dictionary_gloss', 'movDir')

        # Deleting field 'Gloss.movMan'
        db.delete_column(u'dictionary_gloss', 'movMan')

        # Deleting field 'Gloss.contType'
        db.delete_column(u'dictionary_gloss', 'contType')
