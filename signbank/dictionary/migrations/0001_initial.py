    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handedness', models.CharField(blank=True, max_length=5, null=True, verbose_name=b'Handedness', choices=[(b'0', b'-'), (b'1', b'N/A')])),
                ...
                ('handCh', models.CharField(blank=True, max_length=5, null=True, verbose_name=b'Handshape Change', choices=[(b'0', b'-'), (b'1', b'N/A')])),
                ...
                ('movDir', models.CharField(blank=True, max_length=5, null=True, verbose_name=b'Movement Direction', choices=[(b'0', b'-'), (b'1', b'N/A')])),
                ('movMan', models.CharField(blank=True, max_length=5, null=True, verbose_name=b'Movement Manner', choices=[(b'0', b'-'), (b'1', b'N/A')])),
