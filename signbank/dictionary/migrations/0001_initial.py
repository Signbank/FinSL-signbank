    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(max_length=20, verbose_name=b'Type', choices=[(b'note', 'Note'), (b'privatenote', 'Private Note'), (b'phon', 'Phonology'), (b'todo', 'To Do'), (b'sugg', 'Suggestion for other gloss')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('absolute_orientation_fingers', models.ForeignKey(related_name='absolute_orientation_fingers', db_column=b'absolute_orientation_fingers', to_field=b'machine_value', to='dictionary.FieldChoice')),
                ('absolute_orientation_palm', models.ForeignKey(related_name='absolute_orientation_palm', db_column=b'absolute_orientation_palm', to_field=b'machine_value', to='dictionary.FieldChoice')),
                ('contact_type', models.ForeignKey(related_name='contact_type', db_column=b'contact_type', to_field=b'machine_value', to='dictionary.FieldChoice')),
                ('dialect', models.ManyToManyField(to='dictionary.Dialect')),
                ('handedness', models.ForeignKey(related_name='handedness', db_column=b'handedness', to_field=b'machine_value', to='dictionary.FieldChoice')),
                ('handshape_change', models.ForeignKey(related_name='handshape_change', db_column=b'handshape_change', to_field=b'machine_value', to='dictionary.FieldChoice')),
            ],
            options={
                'ordering': ['idgloss'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(to='dictionary.FieldChoice', db_column=b'MorphologyType', to_field=b'machine_value')),
            ],
        ),
        migrations.CreateModel(
            name='Relation',
        ...
        migrations.AddField(
            model_name='gloss',
            name='location',
            field=models.ForeignKey(related_name='location', db_column=b'location', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='movement_direction',
            field=models.ForeignKey(related_name='movement_direction', db_column=b'movement_direction', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='movement_manner',
            field=models.ForeignKey(related_name='movement_manner', db_column=b'movement_manner', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='movement_shape',
            field=models.ForeignKey(related_name='movement_shape', db_column=b'movement_shape', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='named_entity',
            field=models.ForeignKey(related_name='named_entity', db_column=b'named_entity', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='orientation_change',
            field=models.ForeignKey(related_name='orientation_change', db_column=b'orientation_change', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='relation_between_articulators',
            field=models.ForeignKey(related_name='relation_between_articulators', db_column=b'relation_between_articulators', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='relative_orientation_location',
            field=models.ForeignKey(related_name='relative_orientation_location', db_column=b'relative_orientation_location', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='relative_orientation_movement',
            field=models.ForeignKey(related_name='relative_orientation_movement', db_column=b'relative_orientation_movement', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='semantic_field',
            field=models.ForeignKey(related_name='semantic_field', db_column=b'semantic_field', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='strong_handshape',
            field=models.ForeignKey(related_name='strong_handshape', db_column=b'strong_handshape', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='gloss',
            name='weak_handshape',
            field=models.ForeignKey(related_name='weak_handshape', db_column=b'weak_handshape', to_field=b'machine_value', to='dictionary.FieldChoice'),
        ),
        migrations.AddField(
            model_name='dialect',
            name='language',
