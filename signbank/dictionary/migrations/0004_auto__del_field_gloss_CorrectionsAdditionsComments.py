...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Gloss.CorrectionsAdditionsComments'
        db.delete_column('dictionary_gloss', 'CorrectionsAdditionsComments')

    def backwards(self, orm):

        # Adding field 'Gloss.CorrectionsAdditionsComments'
        db.add_column('dictionary_gloss', 'CorrectionsAdditionsComments', self.gf(
