...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gloss.initial_relative_orientation'
        db.add_column('dictionary_gloss', 'initial_relative_orientation',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Gloss.final_relative_orientation'
        db.add_column('dictionary_gloss', 'final_relative_orientation',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=10, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Gloss.initial_relative_orientation'
        db.delete_column('dictionary_gloss', 'initial_relative_orientation')

        # Deleting field 'Gloss.final_relative_orientation'
        db.delete_column('dictionary_gloss', 'final_relative_orientation')
