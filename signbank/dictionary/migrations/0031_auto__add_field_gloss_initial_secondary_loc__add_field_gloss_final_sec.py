...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('dictionary_gloss', 'initial_secondary_loc')
    ...
    models = {
        ...
        'dictionary.gloss': {
            ...
            'final_secondary_loc': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'initial_secondary_loc': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
