...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'dictionary_gloss', 'absOriPalm')

        # Deleting field 'Gloss.absOriFing'
        db.delete_column(u'dictionary_gloss', 'absOriFing')

        # Deleting field 'Gloss.repeat'
        db.delete_column(u'dictionary_gloss', 'repeat')

        # Deleting field 'Gloss.altern'
        db.delete_column(u'dictionary_gloss', 'altern')

        # Deleting field 'Gloss.phonOth'
        db.delete_column(u'dictionary_gloss', 'phonOth')

        # Deleting field 'Gloss.mouthG'
        db.delete_column(u'dictionary_gloss', 'mouthG')

        # Deleting field 'Gloss.mouthing'
        db.delete_column(u'dictionary_gloss', 'mouthing')

        # Deleting field 'Gloss.phonetVar'
        db.delete_column(u'dictionary_gloss', 'phonetVar')

        # Deleting field 'Gloss.iconImg'
        db.delete_column(u'dictionary_gloss', 'iconImg')

        # Deleting field 'Gloss.tokNo'
        db.delete_column(u'dictionary_gloss', 'tokNo')

        # Deleting field 'Gloss.tokNoSgnr'
        db.delete_column(u'dictionary_gloss', 'tokNoSgnr')

        # Deleting field 'Gloss.tokNoA'
        db.delete_column(u'dictionary_gloss', 'tokNoA')

        # Deleting field 'Gloss.tokNoV'
        db.delete_column(u'dictionary_gloss', 'tokNoV')

        # Deleting field 'Gloss.tokNoR'
        db.delete_column(u'dictionary_gloss', 'tokNoR')

        # Deleting field 'Gloss.tokNoGe'
        db.delete_column(u'dictionary_gloss', 'tokNoGe')

        # Deleting field 'Gloss.tokNoGr'
        db.delete_column(u'dictionary_gloss', 'tokNoGr')

        # Deleting field 'Gloss.tokNoO'
        db.delete_column(u'dictionary_gloss', 'tokNoO')

        # Deleting field 'Gloss.tokNoSgnrA'
        db.delete_column(u'dictionary_gloss', 'tokNoSgnrA')

        # Deleting field 'Gloss.tokNoSgnrV'
        db.delete_column(u'dictionary_gloss', 'tokNoSgnrV')

        # Deleting field 'Gloss.tokNoSgnrR'
        db.delete_column(u'dictionary_gloss', 'tokNoSgnrR')

        # Deleting field 'Gloss.tokNoSgnrGe'
        db.delete_column(u'dictionary_gloss', 'tokNoSgnrGe')

        # Deleting field 'Gloss.tokNoSgnrGr'
        db.delete_column(u'dictionary_gloss', 'tokNoSgnrGr')
