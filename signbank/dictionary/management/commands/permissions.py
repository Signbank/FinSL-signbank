...
change_gloss = Permission.objects.get(
    codename='change_gloss', content_type__model__exact='gloss')
advanced_search = Permission.objects.get(
    codename='search_gloss', content_type__model__exact='gloss')
view_adv_properties = Permission.objects.get(
    codename='view_advanced_properties', content_type__model__exact='gloss')
export_csv = Permission.objects.get(
    codename='export_csv', content_type__model__exact='gloss')
add_video = Permission.objects.get(
    codename='update_video', content_type__model__exact='gloss')
create_signs = Permission.objects.get(
    codename='add_gloss', content_type__model__exact='gloss')
publish = Permission.objects.get(
    codename='can_publish', content_type__model__exact='gloss')
delete_unpublished = Permission.objects.get(
    codename='can_delete_unpublished', content_type__model__exact='gloss')
delete_published = Permission.objects.get(
    codename='can_delete_published', content_type__model__exact='gloss')
view_interp_note = Permission.objects.get(
    codename='view_interpreterfeedback', content_type__model__exact='interpreterfeedback')
create_interp_note = Permission.objects.get(
    codename='add_interpreterfeedback', content_type__model__exact='interpreterfeedback')
delete_interp_note = Permission.objects.get(
    codename='delete_interpreterfeedback', content_type__model__exact='interpreterfeedback')
delete_gen_feedback = Permission.objects.get(
    codename='delete_generalfeedback', content_type__model__exact='generalfeedback')
change_page = Permission.objects.get(
    codename='change_page', content_type__model__exact='page')
add_page = Permission.objects.get(
    codename='add_page', content_type__model__exact='page')
add_attachment = Permission.objects.get(
    codename='add_attachment', content_type__app_label__exact='attachments')
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        supervisor, created = Group.objects.get_or_create(
            name='Interpreter Supervisor')
        ...
        if len(User.objects.filter(username='publisher')) == 0:
            ...
            ian = User.objects.create_user(
                'interpreter', 'example@example.com', 'interpreter', first_name='Ian', last_name='Interpreter')
            boss = User.objects.create_user(
                'boss', 'example@example.com', 'boss', first_name='Interpreter', last_name='Boss')
            roger = User.objects.create_user(
                'researcher', 'example@example.com', 'researcher', first_name='Roger', last_name='Researcher')
            olive = User.objects.create_user(
