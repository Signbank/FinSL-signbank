...
class Sign(models.Model):
   ...
   # ant3 = models.ForeignKey("self", db_column="ant3",
   # related_name="antonym3", null=True) # antonym
    ...
    # This field type is a guess.
    CorrectionsAdditionsComments = models.TextField(blank=True)
    ...
    handedness = models.CharField(
        max_length=10, choices=handedness_choices, blank=True)
  ...
  #   hns = models.TextField(blank=True)
    ...
    Palm_orientation = models.CharField(
        max_length=10, blank=True)  # only used twice = Left
    ...
    qldtf = models.NullBooleanField(
        blank=True, null=True)  # used in Queensland
    ...
    satf = models.NullBooleanField(blank=True, null=True)
    ...
    tastf = models.NullBooleanField(
        blank=True, null=True)  # is it used in Tasmania
    ...
    watf = models.NullBooleanField(blank=True, null=True)
