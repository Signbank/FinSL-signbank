...
urlpatterns = patterns('',
                       ...
                       # definition, the first component of the path is word or feedback in each
                       # case
                       ...
                       url(r'gloss/(?P<idgloss>.+).html$',
                           'signbank.dictionary.views.gloss', name='public_gloss'),

                       url(r'^search/$',
                           'signbank.dictionary.views.search', name="search"),
